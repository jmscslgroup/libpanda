...
#define RESISTANCE_RES (5100)	// 3.56V

#define TIME_PER_BUTTON_PRESS ((unsigned int)(1000000))	// in us
#define TIME_PER_BUTTON_RELEASE ((unsigned int)(1000000))	// in us
#define TIME_PER_POTENTIOMETER_SET ((unsigned int)(1000000))	// in us
