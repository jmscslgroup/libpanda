#!/bin/bash
# Author: Matt Bunting, George Gunter
...
declare -a repositories=(can_to_ros transfer_pkg followerstopperth margin ghostfollower ghostfollower_max micromodel micromodelv2 followerstopperth4rl followerstoppermax velocity_controller ghost_mode velocityramp setpointreader followerstoppermax4rl cbf_v2 setpointreader)
...
rosrun robot_upstart install can_to_ros/launch/vehicle_control_integrated_cbf_v2.launch --user root
