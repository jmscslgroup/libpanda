...
int main(int argc, char **argv) {
	...
	printf("\n------------- nissan5 ------------------\n");
	testCan.notificationCanRead(nissan5, sizeof(nissan5));
	usleep(100000);
	...
	printf("\n------------- nissan6 ------------------\n");
	testCan.notificationCanRead(nissan6, sizeof(nissan6));
	usleep(100000);
	
	printf("\n------------- nissan7 ------------------\n");
	testCan.notificationCanRead(nissan7, sizeof(nissan7));
	usleep(100000);
